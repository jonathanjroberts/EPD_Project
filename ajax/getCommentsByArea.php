...
<?php
	...
	$sql_sectionList = "SELECT section.section_id,section.section_name 
			...
			WHERE section.area_id=$q AND section.section_activeFlag=1 AND equipment.section_id=section.section_id";
		...
		while(list($equipment_id,$equipment_shortname) = mysqli_fetch_array($results_visableEquipmentList_in_Section)){		
			...
			echo "</tr>";	
				...
				while(list($comment_id,$comment_value,$user_id,$datetime_created) = mysqli_fetch_array($results_visableCommentList_in_Equipment)){		
						echo "<tr>";
						echo "<td></td> <td><b>$datetime_created:</b></td> <td>$comment_value</td> <td>$user_id</td> <td><a href='comment/show_or_hide.php?area_id=$q&section_id=$section_id&equipment_id=$equipment_id&comment_id=$comment_id'>Hide</a> | <a href='comment/edit.php?area_id=$q&section_id=$section_id&equipment_id=$equipment_id&comment_id=$comment_id'>Edit</a> | <a href='comment/delete.php?comment_id=$comment_id'>Delete</a> </td>";
						echo "</tr>";
				}					
