...
<head>
	<title>Admin > Menu > Equpiment > Add</title>
	<style> 
...
<!-- http://localhost/PMBA/EPD/public/admin/equipment/add.php -->

<br /> <h2> Admin > Menu > Equpiment > Add</h2> <hr />
...
<?php
	...
	while(list($equipment_id,$section_id,$equipment_shortname,$equipment_longname,$equipment_activeFlag) = mysqli_fetch_array($results)){
		//echo "$section_id";  -- really should get this from $sectionList
