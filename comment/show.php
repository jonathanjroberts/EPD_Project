...
<head>
	<title>Section > Equipment > Show Comment</title>
</head>
...
<br /> <h2> Section > Equipment > Show Comment </h2> <hr />
...
<?php
	...
	{	
		...
		echo "<br /><br />";
		echo "<b>Is currently set to: </b>"; if ($comment_showFlag == 1) {echo "Show"; } else { echo "Hidden"; }
		echo "<br /><br /><br />";
		
		// Start Comment Form
		echo "<form method='post' action=''>";
		echo "<input type='hidden' name='comment_showFlag' value='1'>";  // Value of 0 = Set Comment to Hide | Value of 1 = Set Comment to Show
		...
		if (isset($_POST['comment_showFlag']) and $_POST['comment_showFlag']!="")
		{
			...
			if ($countComment > 0){
				echo "<br /><br />";
				echo "Your comment is now hidden for $section_name  >  Equipment Id: $equipment_shortname";
			} else {
				echo "<br /><br />";
